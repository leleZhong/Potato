...
public class BlockManager : MonoBehaviour
{
    ...
    void InitializeBlocks()
    {
        ...
        foreach (Transform cubeTransform in tower1Transforms)
        {
            ...
            Debug.Log("Selected Index: " + SelectedDuplicatedNumberIndex + ", List Count: " + availableNumbers.Count);
        ...
        foreach (Transform cubeTransform in tower2Transforms)
        {
            ...
            block.transform.parent = cubeTransform;
            Debug.Log("Selected Index2: " + SelectedDuplicatedNumberIndex + ", List Count2: " + availableNumbers.Count);
